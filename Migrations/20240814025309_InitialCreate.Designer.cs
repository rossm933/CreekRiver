...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20240814025309_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Campsite", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://blog-assets.thedyrt.com/uploads/2018/05/picking-a-campsite.jpg",
                        ...
                        new
                        {
                            Id = 3,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://www.nps.gov/noca/planyourvisit/images/cleancampsite.jpg",
                        ...
                        new
                        {
                            Id = 4,
                            CampsiteTypeId = 4,
                            ImageUrl = "https://www.fs.usda.gov/Internet/FSE_MEDIA/fseprd923724.jpg",
                            Nickname = "Camp Derek"
                        },
                        new
                        {
                            Id = 5,
                            CampsiteTypeId = 3,
                            ImageUrl = "https://cdn.vox-cdn.com/thumbor/FMUIaXcnBaKK9YqdP8qtxUog150=/0x0:4741x3161/1200x800/filters:focal(1992x1202:2750x1960)/cdn.vox-cdn.com/uploads/chorus_image/image/59535149/shutterstock_625918454.0.jpg",
                            Nickname = "Camp Ross"
                        },
                        new
                        {
                            Id = 6,
                            CampsiteTypeId = 2,
                            ImageUrl = "https://algonquinbeyond.com/wp-content/uploads/2010/01/Farm-Lake-Algonquin-Park-Campsite-3-Interior-2.jpg",
                            Nickname = "Camp Odie"
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 1,
                            CheckinDate = new DateTime(2023, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckoutDate = new DateTime(2024, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserProfileId = 1
                        });
                });
