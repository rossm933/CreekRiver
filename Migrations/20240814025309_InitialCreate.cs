    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "rossm399@aol.com", "Ross", "Morgan" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "https://blog-assets.thedyrt.com/uploads/2018/05/picking-a-campsite.jpg", "Camp Andrew" },
                    { 3, 3, "https://www.nps.gov/noca/planyourvisit/images/cleancampsite.jpg", "Camp Taylor" },
                    { 4, 4, "https://www.fs.usda.gov/Internet/FSE_MEDIA/fseprd923724.jpg", "Camp Derek" },
                    { 5, 3, "https://cdn.vox-cdn.com/thumbor/FMUIaXcnBaKK9YqdP8qtxUog150=/0x0:4741x3161/1200x800/filters:focal(1992x1202:2750x1960)/cdn.vox-cdn.com/uploads/chorus_image/image/59535149/shutterstock_625918454.0.jpg", "Camp Ross" },
                    { 6, 2, "https://algonquinbeyond.com/wp-content/uploads/2010/01/Farm-Lake-Algonquin-Park-Campsite-3-Interior-2.jpg", "Camp Odie" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 1, new DateTime(2023, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
